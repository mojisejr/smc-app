...
export async function loadDisplaySlotConfigAsync(): Promise<SlotDisplayConfig> {
  try {
    ...
    const config =
      deviceConfigs[deviceType as keyof typeof deviceConfigs] ||
      deviceConfigs.DS12;
...
export function getResponsiveGridConfig(): {
  ...
  if (slotCount <= 12) {
    ...
    containerClass =
      "h-full place-content-center place-items-center px-[2vw] py-[2vh] lg:px-[3vw] lg:py-[3vh] xl:px-[4vw] xl:py-[2vh]";
  } else {
    // DS16 Configuration: Compact responsive spacing
    gapClass = "gap-3 lg:gap-4 xl:gap-6";
    containerClass =
      "h-full place-content-center place-items-center px-[1.5vw] py-[1.5vh] lg:px-[2vw] lg:py-[2vh] xl:px-[3vw] xl:py-[1.5vh]";
  }
...
export function getSlotStylingConfig(): {
  ...
  if (slotCount <= 12) {
    ...
    return {
      slotSizeClass:
        "w-full aspect-square min-w-[180px] max-w-[min(500px,30vw)] min-h-[180px]",
    ...
    return {
      slotSizeClass:
        "w-full aspect-square min-w-[140px] max-w-[min(400px,24vw)] min-h-[140px]",
