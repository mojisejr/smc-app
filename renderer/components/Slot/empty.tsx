    ...
    <div className={`relative ${slotSizeClass}`}>
      ...
      <div
        className={`relative w-full h-full ${
          isActive ? "bg-[#F6F6F6] cursor-pointer" : "bg-[#eee] opacity-30"
      ...
      >
        ...
        <div className="flex flex-col pt-2 lg:pt-3 xl:pt-4 justify-center items-center min-h-[50px] lg:min-h-[55px] xl:min-h-[60px] 2xl:min-h-[65px]">
          <div className="font-bold text-sm lg:text-base xl:text-lg 2xl:text-2xl">
            ปลดล็อคช่องที่ {slotNo}
          </div>
        </div>
        <div className="flex flex-col leading-4 pt-1 lg:pt-2 px-1 items-start">
          ...
          <div className={`flex w-full ${indicatorSpacing}`}>
            {isActive ? (
              ...
              <div className={`opacity-30 flex w-full ${indicatorSpacing}`}>
        ...
        <div
          className={`absolute bottom-2 right-2 text-[#615858] ${slotNumberClass} font-bold text-4xl`}
        >
          {slotNo}
        </div>
      </div>
